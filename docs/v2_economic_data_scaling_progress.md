...
Fresh training is frozen in the `data_refits` directory selected by `stage_c_refit_root`. Four original model graphs/seeds11,29,47 and60maximum epochs retain original early stopping/optimizer/selector and compatible new parents. The old interrupted plan is separately bound. The first new worker startup was rejected by the clean-commit guard before data loading or any fit; exact stdout is retained. Commit the verified implementation before retrying that same plan. No completed corrected-data fit or profitability verdict follows from these checks.
...
Composition recovery verified for implementation e6ed47a2d488e8eb036700f7791b46a2275e91ae: event_composition_e6ed47a.zip, SHA b6ab77089626ed800ad382b2afa2b323765f20580f4f58ea6b01a711036a3842,1,583,737bytes.175unique/181logical members,6aliases,one original PDF restore/hash-check.660bounded audit-view arrays/331,950,069cells reconstruct from the bound immutable Natura parent plus sparse deltas to exact saved byte hashes;33views,4.227805s. No immutable input/store/old-fit copies in the archive. Prior cost/ENAT/Natura/source recoveries remain dependencies. Exact pre-output closeout bytes restore from the previous archive, while the canonical closeout advances. StageA and this delivery block remain incomplete; C/D unstarted.

## 2026-09-20 — Complete source/data composition and continuous execution

The user paused the one-minute heartbeat and requested continuous implementation. The scheduler is paused; research continues directly. PROJECT_CONTEXT.md now contains current contracts and pointers; its complete prior bytes are retained in docs/PROJECT_CONTEXT_HISTORY.md instead of forcing every startup to reread historical campaigns.

The [complete composed store](v2_COMPOSED_DATA_STORE.md) is accepted through composed_data_inputs/economic_refit_inputs. All106arrays/3717dates/933names/full60history remain. Sixty-seven changed arrays independently reconcile2,519,791,470cells;39arrays retain parent hashes. Nineteen actual combined dataset/collator samples check224,575,552comparisons with no mismatch, future-feature/revoked-target checks pass and old-parent weights are rejected. Earlier185/303/124/877 per-family proofs and33 corporate target views are reused.

One final target production adds596 newly usable same-class/eligibility outcomes (275ALSO/300AZZA/21ARZZ) plus72 already qualified corporate outcomes. Independent Decimal arithmetic covers the596;34,648,044unchanged raw outcome cells match. SSBR's ten preceding entry dates all fail original liquidity eligibility, so it contributes no new crossing outcomes. Actual final virtual primary attribution on1239affected dates changes126777values, gains668/no losses. Existing live peer/unit uncertainty losses and unsupported M1/ENAT histories remain. No account book, neural forward, scoring or fit ran.

Target/endpoint/successful-assembly/combined-qualification/virtual-attribution seconds:6.2806/.7045/66.0237/71.1859/42.8457. An initial pre-numerical Path error and three out-of-space assembly attempts are retained; targets were reused. Exact duplicate checks permit removing74 temporary recovery NPY copies (3,843,928,280bytes), while original views/archives/accepted stores remain. New files are independent and losslessly compressed; compression alone was insufficient. Read-only tool errors and a six-query calendar follow-up are labelled reconstructed notes; the follow-up supplied no additional admissible evidence and no PDF was downloaded again.

The new store manifest is fab704fccbd7ceed0624bcfcc67178327f392e43d124242caf8d77ff1c64dfc0. Both earlier stores/oldfits stay immutable. January25 and integrated StageA remain; C/Dunstarted. No corrected profitability or completion percentage. Recovery receipt follows after verification.
...
Integrated recovery verified: implementation8d2d59d69004b6e9dcb3e13999e0e23f7e549fe8, archive `integrated_account_8d2d59d.zip`, SHA5c9dd99dfee629fa32a1bb6d59bf05d4229ce07d8dc422613705f27556c71628, 2,706,018bytes. All572unique/578logical members and6aliases restore/hash-check in0.671845s. Current runtime/ops/terms/config/frozen plans/failed-qualified fixtures and bounded exposure output recover with prior calendar/store/source archives; no immutable input/store/old-fit copies. StageA acceptance remains scoped; C preparation continues.

## 2026-09-20 — Matched account results and actual-exposure data repairs

[Matched economic replays](v2_MATCHED_ECONOMIC_REPLAYS.md) records 160 combined accounting/source books (100 corrected, 60 reused), 1,062 completed one-factor sensitivities and 618 explicit unexposed skips. The first refit was interrupted before any saved epoch/checkpoint/score when actual holdings exposed fourteen additional security events. Original forecasts, static PolicyData, accepted stores and fits remain immutable. Twenty-seven original PDFs were recovered; 25 originals/34 pages qualify, with two leads retained separately. Source-identity reopening and pending-claim underlying rekeying now work in both accounts. Five distinct new runtime tests plus 53 affected cases pass; exact failed fixtures/recipes remain.

The 1,062 first-pass sensitivity books took 1,844.60449 summed case seconds. Saved qualification checks 133,104 NAVs, 626,520,528 account cells and 2,855,526 fills in 37.69348 seconds, with maximum NAV discrepancy R$7.45058e-9. Independent dated charges, invoices, spot cash queues, funding and custody liability pass. No opposing security/day spot fills or loan cash redemptions occur. Recall/denial stress can retain unresolved obligations; arithmetic agreement is not executable resolution. All earlier adaptive fixed-fee uncertainty remains.

Old-coordinate four-fold ensemble means above CDI move from original to corrected account/source as follows (bps/day): C6 .66502→.76818, full attention .36680→.52946, wider attention 1.70514→1.38097, GRU early peers 1.04938→1.10752. Wider-minus-full +.85150 and GRU-minus-full +.57806 have 40-session interval lower endpoints below zero. These are existing-forecast comparisons, not completed corrected-data refits or an adoption verdict. Resolve stage_c_account_results for attribution, all seeds/folds, three currency Sharpes and bounded sensitivity effects.

Five market continuations restore 240 eligible days and retire 24 stale cells. Old holding JSL→SIMPAR and new logistics JSLG11→JSL remain distinct historical episodes. Wealth controls, one daily reducer pass, own-legal issuer propagation and lending qualify as intermediates. Shared issuer identities stay exact; SIMPAR/TIM do not inherit predecessor filings or capital units. Daily support retains 2,400 new live peer losses under unchanged rules; 17 BRAV utilization losses independently follow an existing RRRP unit-uncertainty barrier. Completed controls and saved reducers are reused. Common/sector/native/scalar/auxiliary/market/target composition and one combined store/consumer proof still precede compatible P/F fits. C is active, D conditional; the heartbeat remains paused.

## 2026-09-20 — Complete matched data and compatible refits

The later [matched acceptance](v2_matched_data_inputs.json) supersedes the intermediate queue above: all feature and target dependencies are complete. The106-array store on C, manifestfd4ad71a0efaad0914520c89d589e0c0dfd9665158204c4721f821f9df8d4161, retains every933name/3717date/full60. Seventy changed arrays reconcile2,596,086,612cells;36parent arrays remain hash-exact. Combined272 actual dataset/collator samples check3,220,982,288comparisons, with independent virtual-target/causality/old-parent guards. Gross outcomes gain1,389; neutral outcomes gain1,534, including145 existing outcomes with restored risk. Earlier per-family and source proofs are reused.

Recovery matched_store_eb0d407.zip SHAa952bcfb6d234a75f0e3fb2cabe6d36817e1190060a82f496258b91711b6bbe1,199,031,076bytes, verifies452unique/472logical/20aliases and942 reused prior-archive members. All70 changed arrays reconstruct exactly in68.54615seconds;36arrays/51tables/two indices preserve bound dependencies. No immutable source/store/old-fit copies were added.

[Fresh matched refits](v2_MATCHED_REFITS.md) now run continuously in an isolated clean checkout. The four parents completed before a clean-worktree interruption are reused. Original60fit recipes and the96book neutral evaluation are frozen; no new capacity contrast has begun. New portfolio-risk/cache composition is qualified, with original formulas, backward fallback/identity checks, strict prior references and explicit unused CDI prelude. Exact qualifier failures/resumes remain; no completed reducer/book was repeated. Original stores and fits stay immutable. D and any profitability verdict remain conditional on the corrected comparisons.


## 2026-09-21 — Matched comparison complete; bounded capacity work active

[Final matched results](v2_MATCHED_RESULTS.md) bind all60 original-recipe fits,96 primary books,1065 ordinary sensitivities,90 funded-denial books and9 actual SOMA precision books. Unexposed615/6/39 branches remain explicit skips. R$10m equal-four-fold means above CDI are full attention .9992054, wider attention -.1437482, GRU .6806907 and C6 .4564605bps/day. Wider/GRU advantages over full are -1.1429536/-.3185147, so the registered ten-fold condition stops both. No model adoption or held-out result. All three Sharpes, paired20/40/60 uncertainty, seeds/folds/capitals, trading statistics and component costs are saved. Eleven primary books retain admitted ENAT marked fractions; none has overdue principal or loan cash redemption. Scenario overdue intervals remain unresolved execution stress, with no terminal overdue principal.

A C6/F10 SULA-unit fraction sensitivity exposed a due-day partial-return ordering defect. The narrow shared-subledger fix rounds only unreturned cohorts and retains physically due cohorts for original close interest/payment; earlier successful branches are unchanged. Four new and sixteen existing tests pass; exact failed fixture and corrected same-day-cover expectation retained. Three newly exposed capital books receive independent Decimal fraction and saved-intention differentiable-account verification,378NAVs, maximumR9.31323e-9,2.35276seconds. No source campaign, completed book or fit rerun. The final C6 compiler-cache resumption completes all60 fits and binds its logs.

Stage D now freezes the registered two width cells only: attention96→128(1674947parameters) and GRU64→96(1549603),30fresh compatible fits with C controls reused. Runtime3b0f921 keeps the original one-layer model implementation plus the narrow loan correction; short Triton cache and all933/full60/original budgets remain. The separately prepared depth implementation has one-layer output/gradient identity and27targeted tests, but no depth fit has started. C recovery follows while D progresses. Heartbeat remains paused.

C recovery verifies all21810logical/16912unique members/4898aliases and770inherited dependencies: matched_refits_db1944f.zip SHA385d4d3d2674cd1ae5aae9f5bd872111f1d1bdc0588603f8c4abee98f4a0a2a8,4971755703bytes,238.89938seconds archive/58.14749seconds restore-hash verification. No source/accepted-store/old-fit copies. Current width evaluation is frozen before any candidate portfolio result, using unchanged C producers through a private pointer context; depth runner and generic capacity readouts reuse those loops and remain unexecuted.

The registered LSTM option is implemented as an explicit one/two-layer recurrent alternative, with unchanged shared calendar-history encoding, masks/ages, early peers, pooling and other modules. Four new CPU tests pass in8.98seconds,20prior cases deselected; no failed or repeated campaign. stage_d_lstm_engineering retains the pre-edit plan, exact before/after source and test stdout. Width continues on isolated3b0f921; the qualified depth runtime734cf12 remains unchanged. No LSTM fit or outcome exists; its comparison waits for recurrent diagnostics. Candidate evaluation/readouts/recovery now support the three registered wave names and retain an exact executed evaluation recipe before any candidate book.
