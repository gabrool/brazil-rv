...
The [surviving-company rename propagation](docs/v2_SURVIVING_RENAME_PROPAGATION.md) admits source-clocked SSBR→ALSO and ARZZ→AZZA spot identities, adds55/60eligible days and preserves all933/full60history. Qualified wealth/daily/risk/peer proofs are reused. Common state, issuer/financial/events/sector/lending and microstructure/options/odd-lot/index dependencies now pass158,241,768typed control cells and303/124 actual consumer samples. Existing inherited DISMES barriers remove226 previously supported live sidecar cells;47 other losses are retired predecessor cells. Raw74valuation dates are distinct from45previously eligible valuation-field losses. No thresholds, source values or research runtime changed. Native M1/scalars, magnitude/cross-market and final target/new-store composition remain, followed by January25 disposition and integratedStageA. Both accepted stores and old fits stay sealed; no loan alias, model result or C/D start. This remains the existing composition block.

The [event/source composition evidence](docs/v2_EVENT_SOURCE_COMPOSITION.md) reuses the seven qualified distributions, Natura and Cielo terms without numerical account changes. Sparse succession attribution adds72 valid gross/neutral outcomes and closes2,806 already-unquoted source-entry permissions while retaining all24 post-effect eligibility cells; actual33full933/full60 target consumers pass. This is not a complete new refit store or StageA acceptance. Original CVM528672 corroborates December30 2016 market settlement closure, leaving January25 2017 as the remaining old-equity calendar gap; no arrays or rent clocks changed. The absent SSBR->ALSO and ARZZ->AZZA links require separately sourced, bounded dependency propagation before final data composition. Both accepted stores and old fits remain sealed; C/D unstarted.

The [historical-cost block closeout](docs/v2_SPOT_INVOICE_CLOSEOUT.md) adds the applicable spot invoice hypothesis in both accounts: same-direction security/day six-decimal fees, account/category cent truncation, separate adjustment on the original T+3/T+2 cash queue. Unrounded fractional research costs remain primary; grouping, fractional applicability and earlier-date backcast stay explicit hypotheses. Six new variants qualify against six reused saved parents; no old book/source/store replay. This completes the bounded historical-cost block, not Stage A. Opposite-fill daytrade admission and Cielo held-loan precision are conditional on actual exposure. The new 2016 calendar and two manual leads do not resolve December30 2016/January25 2017; one manual is a 2011 mirror and the 2017 B3 document is an unapproved draft. Calendar/event/source-data composition and integrated admission remain before C/D.

The [historical cost contract](docs/v2_HISTORICAL_COST_COVERAGE.md) qualifies dated ordinary-CNPJ spot/custody/maintenance costs for July18 2016–December30 2024 and corporate physical custody in both accounts. Fifty original monthly tariff archives cover 1,014 development dates; 976 use the sourced fixed regime and 109 retain explicit source-supported trading-rate bounds. Positive undelivered rights, physical stock, maintenance, expense/payment and unpaid debt remain separate; rights inclusion and valuation/payment conventions are hypotheses. Eighteen historical-cost and 34 corporate adaptive synthetic books are independently qualified, with 14 unexposed variants skipped. Reuse these and all prior proofs; no model scoring/profitability or store/fit mutation. Dated source composition resolves November20 2017 clearing; December30 2016 and January25 2017 remain. Spot invoice treatment, event/data composition and integrated Stage A admission precede C/D. See the [three-block closeout](docs/v2_STAGE_A_CLOSEOUT.md).

The earlier [ordinary custody](docs/v2_CUSTODY_FEES.md) and [dated spot](docs/v2_HISTORICAL_SPOT_COSTS.md) proofs remain dependencies. Primary post-February2021 3bp B3 plus 1bp provisional shortfall and zero brokerage replaces the old bundled4bp; no double charge or ordinary-CNPJ fund discount. Their 30-book matrices, payment/base and auction/brokerage/shortfall/proceeds sensitivities are complete and must not repeat. No adaptive debit exposure was established; funded debit is separately fixture-verified. Both accepted stores and original fits stay sealed. Cielo held-loan cents remain conditional: none of the 34 new corporate paths has an actual loan redemption. Preserve all measured adaptive uncertainty.
...
accrued liabilities through return, and the old contract minimum; loan references
