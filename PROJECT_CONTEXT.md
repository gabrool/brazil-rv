...
The [surviving-company rename propagation](docs/v2_SURVIVING_RENAME_PROPAGATION.md) admits source-clocked SSBR→ALSO and ARZZ→AZZA spot identities, adds55/60eligible days and preserves full933/full60history. Wealth and daily/risk/peer amendments pass83,150,470control cells and185actual consumer samples/2,009,467,410packed cells.620still-active peer-field losses retain unchanged support thresholds and are enumerated. Source-mask/activity reconstruction failures are retained; saved reducers reused. Common-state, issuer/financial, lending-denominator, native/scalar/auxiliary and final target/store composition remain. No accepted store, old fit or loan alias changes; January25 calendar and integratedStageA still precede C/D. This is progress within the existing composition block, not a new campaign or StageA acceptance.
