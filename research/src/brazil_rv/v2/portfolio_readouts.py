...
def book_summary(data, result, previous, start, first):
    ...
    daily = {
        ...
        * 1e4,
        "custody_base": result.custody_base[selection],
        "custody_maintenance": result.custody_maintenance[selection],
        "custody_physical_base": result.custody_physical_base[selection],
        "custody_claim_base": result.custody_claim_base[selection],
        "custody_payment": result.custody_payment[selection],
        "custody_liability": result.custody_liability[selection],
