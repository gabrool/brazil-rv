...
DISCOVERY_FIT_DATE_COUNTS: Mapping[str, int] = MappingProxyType(
    {"fold_a": 512, "fold_b": 614}
)
DISCOVERY_SELECTION_DATE_COUNT = 102
THIRD_DISCOVERY_FIT_END = date(2023, 3, 31)
THIRD_DISCOVERY_SELECTION_START = date(2023, 4, 3)
THIRD_DISCOVERY_SELECTION_END = date(2023, 8, 31)

EFFECTIVE_BATCH_SIZE = 512
MAX_EPOCHS = 20
EMA_DECAYS = (0.98, 0.99, 0.995)
