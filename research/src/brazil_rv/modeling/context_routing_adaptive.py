...
CONTROL_RUN_COUNT_MINIMUM = 1
CONTROL_RUN_COUNT_MAXIMUM = 3
...
TOTAL_TRAINING_RUN_COUNT_MINIMUM = (
    CONTROL_RUN_COUNT_MINIMUM + ROUTING_RUN_COUNT_MINIMUM + ISSUER_RUN_COUNT_MINIMUM
)
TOTAL_TRAINING_RUN_COUNT_MAXIMUM = (
    CONTROL_RUN_COUNT_MAXIMUM + ROUTING_RUN_COUNT_MAXIMUM + ISSUER_RUN_COUNT_MAXIMUM
)
