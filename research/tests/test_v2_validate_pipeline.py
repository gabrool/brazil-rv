...
def test_development_acceptance_requires_registered_sanity_bounds() -> None:
    economics = {
        ...
        "terminal_settlement_notional": 0.0,
        "terminal_settlement_notional_fraction_nav": 0.0,
        "settled_then_printed_count": 0,
        "terminal_settlement_economics_unresolved": False,
