...
- The verified BOVA defect is a stale, unmarked/unrebalanced existing hedge for 92 sessions, not necessarily a zero hedge position. Exactly 92 BDI-02 closes (2019-08-19 through 2019-12-30) are added and all 3,871 old observations remain exact. Causal beta changes can propagate into F5. Replay source/provenance hashes necessarily change and are explicit provenance exemptions, while predictions, labels, populations and score-derived metrics remain exact. The final-source roster is 465 books: 87 screening/selection, 252 final seed-audit panels (including the originally rejected panel), and 126 CPU panels. Failed/interrupted duplicate audit roots remain sealed historical evidence rather than extra final books.
